 ...
 */
public class StudentNotTeamMemberException extends Exception {
    private final StudentNumber student;
    private final TeamID teamID;

    public StudentNotTeamMemberException(StudentNumber sNumber, TeamID tID) {
        super("Student ist not member of the team");
