...
CREATE TABLE `external_database_test`.`DIDACTIC_UNIT` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `course_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '',
...
CREATE TABLE `external_database_test`.`APPOINTMENT` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  ...
  CONSTRAINT `didactic_unit_id_appointment`
    ...
    REFERENCES `external_database_test`.`DIDACTIC_UNIT` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
DELIMITER //
CREATE TRIGGER `external_database_test`.`chk_id_course_group_insert` BEFORE INSERT ON `COURSE_GROUP`
FOR EACH ROW
BEGIN
  IF (NEW.`id` IN (SELECT `id` FROM `external_database_test`.`COURSE_LECTURE`)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'INSERT statement conflicted with CHECK constraint `external_database_test`.`chk_id_course_group_insert`.';
  END IF;
END; //

DELIMITER //
CREATE TRIGGER `external_database_test`.`chk_id_course_group_update` BEFORE UPDATE ON `COURSE_GROUP`
FOR EACH ROW
BEGIN
  IF (NEW.`id` IN (SELECT `id` FROM `external_database_test`.`COURSE_LECTURE`)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'INSERT statement conflicted with CHECK constraint `external_database_test`.`chk_id_course_group_update`.';
  END IF;
END; //

DELIMITER //
CREATE TRIGGER `external_database_test`.`chk_id_course_lecture_insert` BEFORE INSERT ON `COURSE_LECTURE`
FOR EACH ROW
BEGIN
  IF (NEW.`id` IN (SELECT `id` FROM `external_database_test`.`COURSE_GROUP`)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'INSERT statement conflicted with CHECK constraint `external_database_test`.`chk_id_course_lecture_insert`.';
  END IF;
END; //

DELIMITER //
CREATE TRIGGER `external_database_test`.`chk_id_course_lecture_update` BEFORE UPDATE ON `COURSE_LECTURE`
FOR EACH ROW
BEGIN
  IF (NEW.`id` IN (SELECT `id` FROM `external_database_test`.`COURSE_GROUP`)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'INSERT statement conflicted with CHECK constraint `external_database_test`.`chk_id_course_lecture_update`.';
  END IF;
END; //
...
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('1');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('1');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('2');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('2');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('3');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('3');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('4');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('4');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('1', '1', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('2', '2', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('3', '1', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('4', '2', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('5', '1', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('6', '2', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('7', '1', '30');
INSERT INTO `external_database_test`.`COURSE_GROUP` (`id`, `group_number`, `max_group_size`) VALUES ('8', '2', '30');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('1', '2015-10-06 08:15:00', '2015-10-06 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('1', '2015-10-27 08:15:00', '2015-10-27 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('2', '2015-10-15 08:15:00', '2015-10-15 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('2', '2015-10-29 08:15:00', '2015-10-29 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('3', '2015-10-14 12:30:00', '2015-10-14 15:45:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('3', '2015-10-28 12:30:00', '2015-10-28 15:45:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('4', '2015-10-13 08:15:00', '2015-10-13 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('4', '2015-11-03 08:15:00', '2015-11-03 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('5', '2015-10-22 08:15:00', '2015-10-22 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('5', '2015-11-05 08:15:00', '2015-11-05 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('6', '2015-10-21 12:30:00', '2015-10-21 15:45:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('6', '2015-11-04 12:30:00', '2015-11-04 15:45:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('7', '2015-10-14 12:30:00', '2015-10-14 14:00:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('7', '2015-10-28 12:30:00', '2015-10-28 14:00:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('8', '2015-10-14 14:00:00', '2015-10-14 15:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('8', '2015-10-28 14:00:00', '2015-10-28 15:30:00');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('1');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('2');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('3');
INSERT INTO `external_database_test`.`DIDACTIC_UNIT` (`course_id`) VALUES ('4');
INSERT INTO `external_database_test`.`COURSE_LECTURE` (`id`) VALUES ('9');
INSERT INTO `external_database_test`.`COURSE_LECTURE` (`id`) VALUES ('10');
INSERT INTO `external_database_test`.`COURSE_LECTURE` (`id`) VALUES ('11');
INSERT INTO `external_database_test`.`COURSE_LECTURE` (`id`) VALUES ('12');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('9', '2015-10-25 08:15:00', '2015-10-25 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('9', '2015-11-15 08:15:00', '2015-11-15 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('9', '2015-12-06 08:15:00', '2015-12-06 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('9', '2016-01-08 08:15:00', '2016-01-08 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('10', '2015-10-21 14:00:00', '2015-10-21 15:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('10', '2015-11-04 14:00:00', '2015-11-04 15:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('10', '2015-11-18 14:00:00', '2015-11-18 15:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('10', '2015-12-02 14:00:00', '2015-12-02 15:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('11', '2015-10-26 08:15:00', '2015-10-26 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('11', '2015-11-16 08:15:00', '2015-11-16 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('11', '2015-12-07 08:15:00', '2015-12-07 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('11', '2016-01-09 08:15:00', '2016-01-09 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('12', '2015-10-25 08:15:00', '2015-10-25 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('12', '2015-11-15 08:15:00', '2015-11-15 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('12', '2015-12-06 08:15:00', '2015-12-06 11:30:00');
INSERT INTO `external_database_test`.`APPOINTMENT` (`didactic_unit_id`, `start_date`, `end_date`) VALUES ('12', '2016-01-08 08:15:00', '2016-01-08 11:30:00');
